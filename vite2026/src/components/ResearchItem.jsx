...
export default function ResearchItem({ 
  ...
  return (
    <section className={`relative min-h-screen flex items-center ${bgColor} overflow-hidden border-b border-white/5`}>
      {/* 背景纹理 */}
        ...
        <div className="max-w-5xl">
          ...
          <div className="space-y-12">
            ...
            <div className="relative border-l border-cyan-500/20 pl-6 lg:pl-12 space-y-8">
              ...
              <button onClick={() => setIsExpanded(!isExpanded)} className="mt-6 text-[10px] tracking-[0.3em] uppercase text-cyan-500/80 lg:hidden underline">
